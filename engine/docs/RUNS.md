...
| 7 | 2026-06-26 | e8/d8 (from run 6) | v5 c48/b5 (from run 6) | Adam lr=1e-3 (from run 6) | **active** — rule change: charge demotes **bottom-N** Kings (cold launched, parity-validated) | [run7.md](runs/run7.md) |
