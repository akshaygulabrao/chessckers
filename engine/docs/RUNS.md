...
| 15 | 2026-07-05 | official full start (same as 14) | v5 c64/b6 ~630K (warm from run 13 — same seed as 14) | Adam lr=1e-3; **policy target = Gumbel improved** (Stage 1), **value = pure z** (q-ratio 0) | **active** — attempt-3 remedy: identical to run 14 except the two training targets; first `feat/gumbel-selfplay` deployment | [run15.md](runs/run15.md) |
