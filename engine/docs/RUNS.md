...
| 14 | 2026-07-02 | **official full starting position** `pppppppp/pkkkkkkp/pppppppp/8/8/8/PPPPPPPP/RNBQKBNR[…24-tower…] w KQkq - 0 1 {wm:2}` (= `STARTING_FEN`, same as run 10) | v5 c64/b6 ~630K (from run 13) | Adam lr=1e-3 (same) | **active** — normal games; **warm-start from run 13's net** (c64/b6, army-vs-towers features); fresh buffer. What does the net learn from the real start? | [run14.md](runs/run14.md) |
