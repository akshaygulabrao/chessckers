...
| 8 | 2026-06-28 | e8/d8 (same as run 7) | v5 c48/b5 (same) | Adam lr=1e-3 (same) | **active** — infra validation: in-fleet gate + `cc strength` (no training change) | [run8.md](runs/run8.md) |
